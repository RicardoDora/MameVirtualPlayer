# Super Tank - utilizando as imagens de resolução baixa (e arrumando o CROP já que a resolução é outra) - mas com a IA do arquivo 5
...
while(True):
    ...
    # localiza o objetivo mais proximo
